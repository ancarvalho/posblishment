...
extension CategoriesQuerySortBy
  ...
  QueryBuilder<Categories, Categories, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<Categories, Categories, QAfterSortBy> sortByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoriesQuerySortThenBy
  ...
  QueryBuilder<Categories, Categories, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<Categories, Categories, QAfterSortBy> thenByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.desc);
    });
  }
...
extension CategoriesQueryWhereDistinct
  ...
  QueryBuilder<Categories, Categories, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CategoriesQueryProperty
  ...
  QueryBuilder<Categories, String, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
